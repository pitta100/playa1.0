...
<h1 class="page-header">Editar compra <a class="btn btn-success" href="#productoModal" class="btn btn-success" data-toggle="modal" data-target="#crudModal" data-c="producto"> Genere un nuevo producto</a> </h1>
<div class="container">
    <div class="row">
    ...
    <?php
     ...
     foreach($this->model->Listar($id_compra) as $r): 
        ...
        <tr>
            ...
            <td>
                <a  class="btn btn-danger" onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=compra&a=EliminarItem&id=<?php echo $r->id; ?>"> <i class="fa-solid fa-ban"></i>  Cancelar</a>
            </td>
        </tr>
    <?php endforeach; ?>
...
<div align="center"><a class="btn btn-lg btn-success " href="#finalizarModal" class="btn btn-success" data-toggle="modal" data-target="#finalizarModal" data-c="compra"> <i class="fa-solid fa-ban"></i>  Finalizar (F4)</a></div>
<?php } ?>
</div> 
</div>
</div>
