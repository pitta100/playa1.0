...
<h1 class="page-header">Sector detalles de la compra</h1> 
...
<table class="table table-striped table-bordered display responsive nowrap" width="100%" id="tabla1">
    ...
    <thead>
        <tr style="background-color: #7dcd5d ; color:#fff">
            ...
            <th> <i class="fa-solid fa-chart-line"></i> Precio compra</th>
            <th> <i class="fa-solid fa-hand-holding-dollar"></i> Precio venta</th>
