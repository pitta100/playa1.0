		...
		<table width"100%" style="border: 1px solid #333; font-size:12px; background-color: #7dcd5d  ; color: white">
			<tr align="center">
                ...
                <th width="12%" style="border-left-width:1px ; border-right-width:1px">Costo</th>
             	...
             	<th width="15%" style="border-left-width:1px ; border-right-width:1px">Pago</th>
			</tr>
		</table>
...
$html1 = <<<EOF
		...
		<table width"100%" style="border: 1px solid #333; font-size:10px">
			<tr align="center">
				...
				<td width="15%" style="border-left-width:1px ; border-right-width:1px">$r->contado</td>
			</tr>
		</table>
...
$html1 = <<<EOF
		<br>
		<h1 align="center"> sector Otros Ingresos</h1>
